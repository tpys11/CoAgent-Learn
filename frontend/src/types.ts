...
export const DEFAULT_AGENTS: AgentConfig[] = [
  ...
  },
  {
    ...
    mode: '均衡',
    modes: [{ label: '均衡', promptOverride: '' }],
    systemPrompt: '你是知识库与搜索 Agent。负责知识库检索与联网搜索：从知识库向量库检索相关片段，必要时联网补充信息；检索增强模板下由子 Agent（知识库管理/搜索）整理检索结果。',
    defaultPrompt: '你是知识库与搜索 Agent。负责知识库检索与联网搜索：从知识库向量库检索相关片段，必要时联网补充信息；检索增强模板下由子 Agent（知识库管理/搜索）整理检索结果。',
