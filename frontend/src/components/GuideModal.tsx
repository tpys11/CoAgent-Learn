        ...
        <div className="flex flex-col gap-5 text-xs leading-relaxed text-gray-700">
          ...
          <section>
            ...
            <ul className="flex flex-col gap-1.5">
              <li className="flex gap-2"><BookOpen size={12} className="text-gray-400 mt-0.5 flex-shrink-0" /><span><b>知识库</b>：项目配置里上传 txt/md/PDF/Word/PPT，AI 回答基于知识库；切换"知识库模式"控制</span></li>
              <li className="flex gap-2"><Brain size={12} className="text-gray-400 mt-0.5 flex-shrink-0" /><span><b>记忆</b>：个人/项目/对话三级画像，刷新后保留</span></li>
              ...
              <li className="flex gap-2"><BarChart3 size={12} className="text-gray-400 mt-0.5 flex-shrink-0" /><span><b>评估</b>：项目配置 → 评估 tab，一键测幻觉率/适配/覆盖率</span></li>
            </ul>
          </section>
          <section>
